...
GOOS=linux go build -o $PKG/bin/linux_amd64/mysql-agent $PKG/cmd/mysql-agent
GOOS=linux go build -o $PKG/bin/linux_amd64/mysql-operator $PKG/cmd/mysql-operator
